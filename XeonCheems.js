...
//[target]\\
	const reply = (teks) => {
        ...
        const replay = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Hi `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://www.youtube.com/channel/UC9iSQ_A_GBZDfIhNBmfW6IQ/featured"}}}, { quoted: m})
        }
try {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
	    ...
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'sc': case 'script': {
                reply('Script : https://github.com/DGXeon/CheemsBot-MD\n Dont Forget To Give Star\n\nYoutube : https://www.youtube.com/channel/UC9iSQ_A_GBZDfIhNBmfW6IQ/featured\n Dont Forget To Subscribe')
            }
            break
            case 'chat': {
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
           ...
           XeonBotInc.sendMessage(m.chat, { audio: devsound, mimetype: 'audio/mp4', ptt: true, quoted: m })
            ...
            break
                    case '56565656565656654545454': case '58585858585885585858585858': {
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube📍',
                                    url: 'https://www.youtube.com/channel/UC9iSQ_A_GBZDfIhNBmfW6IQ/featured'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '👤Owner👤',
